...
from lela._types import Candidate, Document, Entity, Mention
...
class TestLELAvLLMDisambiguatorComponent:
    ...
    @patch("lela.spacy_components.disambiguators._get_vllm")
    @patch("lela.spacy_components.disambiguators.get_vllm_instance")
